...
const CAPABILITIES = [
  ...
  },
  {
    ...
    body: "Anyone can message any agent. Steering stays attributed, so the room remains clear.",
  },
  {
      ...
      <section className="border-t border-[#191919]/08">
        <div className="mx-auto max-w-6xl px-5 sm:px-8 py-20 sm:py-28 grid md:grid-cols-12 gap-10 md:gap-14 items-center">
          <div className="md:col-span-5">
            ...
            <p className="mt-5 text-[15px] leading-relaxed text-[#191919]/65 font-light">Steer turns Cursor and Claude Code into a shared room — multiple agents, presence, attribution, diffs, and control in one place.</p>
          </div>
      ...
      <section className="border-t border-[#191919]/08">
        <div className="mx-auto max-w-6xl px-5 sm:px-8 py-20 sm:py-28">
          <div className="max-w-lg">
            ...
            <h2 className="mt-3 landing-serif text-[32px] sm:text-[40px] leading-[1.12] tracking-tight">From solo runs to a shared multi-agent room</h2>
            <p className="mt-4 text-[15px] leading-relaxed text-[#191919]/65 font-light">One continuous surface for every agent. No meeting link. No “can you see my screen?”</p>
          </div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-16 items-start">
            ...
            <div className="mt-12 md:mt-0 md:col-span-7 space-y-12">
              <div>
                ...
                <p className="mt-3 text-[15px] leading-relaxed text-[#191919]/65 font-light max-w-md">Pair once, keep <code className="landing-mono text-[13px] text-[#191919]">steer start</code> running, and relay prompts to Cursor or Claude Code on your laptop — against any folder you choose.</p>
              </div>
              <div className="border-t border-[#191919]/10 pt-12">
                ...
                <p className="mt-3 text-[15px] leading-relaxed text-[#191919]/65 font-light max-w-md">Cursor Cloud or Claude Code in E2B — point agents at a GitHub repo, stream progress into the room, and keep collaborators in lockstep.</p>
              </div>
            </div>
          </div>
